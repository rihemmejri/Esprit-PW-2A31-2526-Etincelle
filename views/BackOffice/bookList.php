...
<body>
    <div class="container">
        <div class="header">
            ...
            <a href="../BackOffice/addBook.php" class="add-btn">
                        ...
                        <?php if (count($books) > 0): ?> 
                            <?php foreach ($books as $book): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            <a href="../BackOffice/categoryList.php?id=<?= $book->getId() ?>" class="action-btn view" title="Voir détails">
                                                <i class="fas fa-eye"></i>
                                                Voir
                                            </a>
                                            <a href="../BackOffice/editBook.php?id=<?= $book->getId() ?>" class="action-btn edit" title="Modifier">
                                                <i class="fas fa-edit"></i>
                                                Modifier
                                            </a>
                                            <a href="../BackOffice/deleteBook.php?id=<?= $book->getId() ?>" class="action-btn delete" title="Supprimer" 
