        ...
        <form method="POST">
            <div class="form-row">
                <div class="form-group">
                    <label>User ID</label>
<<<<<<< HEAD
                    <input type="number" name="user_id" required value="<?= htmlspecialchars($user_id ?? '') ?>" class="<?= $error ? 'error' : '' ?>">
                    <?php if ($error): ?>
...
<<<<<<< HEAD
                    <input type="number" name="poids" step="0.1" required value="<?= htmlspecialchars($poids ?? '') ?>">
                </div>
                <div class="form-group">
                    <label>Calories Consommées</label>
                    <input type="number" name="calories_consommees" required value="<?= htmlspecialchars($calories_consommees ?? '') ?>">
=======
...
<<<<<<< HEAD
                    <input type="number" name="calories_objectif" id="calories_objectif" readonly required value="<?= htmlspecialchars($calories_objectif ?? '') ?>">
                </div>
                <div class="form-group">
                    <label>Eau Bue (L)</label>
                    <input type="number" name="eau_bue" step="0.1" required value="<?= htmlspecialchars($eau_bue ?? '') ?>">
                </div>
            </div>
            <div class="form-group">
                    <label>Eau Objectif (L)</label>
                    <input type="number" name="eau_objectif" id="eau_objectif" step="0.1" readonly required value="<?= htmlspecialchars($eau_objectif ?? '') ?>">
=======
