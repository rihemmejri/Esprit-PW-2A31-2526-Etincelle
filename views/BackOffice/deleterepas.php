...
<head>
    ...
    <title>Confirmation de suppression - Repas</title>
        ...
        <div class="confirmation-card">
            ...
            <div class="content">
                ...
                <div class="warning-text">
                    ...
                    <span>Cette action est irréversible. Toutes les données associées à ce repas seront définitivement supprimées de la base de données.</span>
                </div>
                
                <div class="actions">
                    <a href="deleteRepas.php?id=<?= $id ?>&confirm=yes" class="btn btn-danger">
                ...
                <div class="footer-note">
                    ...
                    Vous serez redirigé vers la liste des repas après l'action
                </div>
            </div>
        </div>
    </div>
