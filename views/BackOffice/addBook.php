...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST["titre"]) && isset($_POST["auteur"]) && isset($_POST["category_id"])) {
        if (!empty($_POST["titre"]) && !empty($_POST["auteur"]) && !empty($_POST["category_id"])) {
    ...
    <div class="container">
        <div class="form-card">
            <div class="header">
                ...
                <p>Remplissez les informations ci-dessous pour ajouter un nouveau livre</p>
            </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="titre" placeholder="Ex: Le Petit Prince" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="input-icon">
                                ...
                                <input type="text" name="auteur" placeholder="Ex: Antoine de Saint-Exupéry" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="status-group">
                                <div class="status-option">
                                    <input type="radio" name="status" id="status_disponible" value="disponible" checked>
                                ...
                                <div class="status-option">
                                    <input type="radio" name="status" id="status_emprunte" value="emprunté">
                                ...
                                <div class="status-option">
                                    <input type="radio" name="status" id="status_perdu" value="perdu">
                        ...
                        <div class="form-group">
                            ...
                            <div class="copies-input">
                                ...
                                <input type="number" name="number_of_copies" id="number_of_copies" min="1" value="1" readonly>
                                <button type="button" onclick="updateCopies(1)">+</button>
                            </div>
                        </div>
