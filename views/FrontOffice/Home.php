...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Views/assets/vendor/tiny-slider/tiny-slider.css">
	<link rel="stylesheet" type="text/css" href="/Views/assets/vendor/glightbox/css/glightbox.css">
	<link rel="stylesheet" type="text/css" href="/Views/assets/vendor/flatpickr/css/flatpickr.min.css">
	...
	<nav class="navbar navbar-expand-xl">
		<div class="container">
			...
			<a class="navbar-brand" href="index.html">
				<img class="light-mode-item navbar-brand-item" src="/Views/assets/images/logo.svg" alt="logo">
				<img class="dark-mode-item navbar-brand-item" src="/Views/assets/images/logo-light.svg" alt="logo">
			</a>
			<!-- Logo END -->
			...
			<ul class="nav flex-row align-items-center list-unstyled ms-xl-auto">
				...
				<li class="nav-item ms-3 dropdown">
					...
					<a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown" aria-expanded="false">
						<img class="avatar-img rounded-2" src="/Views/assets/images/avatar/01.jpg" alt="avatar">
					</a>
						...
						<li class="px-3 mb-3">
							<div class="d-flex align-items-center">
								...
								<div class="avatar me-3">
									<img class="avatar-img rounded-circle shadow" src="/Views/assets/images/avatar/01.jpg" alt="avatar">
								</div>
								<div>
	...
	<div class="container">
			...
			<div class="row g-4 g-lg-5">
					...
					<div class="hstack gap-4 flex-wrap align-items-center">
						...
						<a data-glightbox="" data-gallery="office-tour" href="https://www.youtube.com/embed/tXHviS-4ygo" class="d-block">
							...
							<div class="avatar avatar-md z-index-1 position-relative me-2">
								<img class="avatar-img rounded-circle" src="/Views/assets/images/avatar/12.jpg" alt="avatar">
								<!-- Video button -->
				...
				<div class="col-lg-6 position-relative">
					...
					<img src="/Views/assets/images/bg/06.jpg" class="rounded" alt="">
					...
					<div class="vstack gap-5 align-items-center position-absolute top-0 start-0 d-none d-md-flex mt-4 ms-n3">
						<img class="icon-lg shadow-lg border border-3 border-white rounded-circle" src="/Views/assets/images/category/hotel/4by3/11.jpg" alt="avatar">
						<img class="icon-xl shadow-lg border border-3 border-white rounded-circle" src="/Views/assets/images/category/hotel/4by3/12.jpg" alt="avatar">
					</div>
				</div>
			</div>
				...
				<div>
					<div class="card border rounded-3 overflow-hidden">
						<div class="row g-0 align-items-center">
							<!-- Image -->
							<div class="col-sm-6">
								<img src="/Views/assets/images/offer/01.jpg" class="card-img rounded-0" alt="">
							</div>
				...
				<div>
					<div class="card border rounded-3 overflow-hidden">
						<div class="row g-0 align-items-center">
							<!-- Image -->
							<div class="col-sm-6">
								<img src="/Views/assets/images/offer/04.jpg" class="card-img rounded-0" alt="">
							</div>
				...
				<div>
					<div class="card border rounded-3 overflow-hidden">
						<div class="row g-0 align-items-center">
							<!-- Image -->
							<div class="col-sm-6">
								<img src="/Views/assets/images/offer/03.jpg" class="card-img rounded-0" alt="">
							</div>
				...
				<div>
					<div class="card border rounded-3 overflow-hidden">
						<div class="row g-0 align-items-center">
							<!-- Image -->
							<div class="col-sm-6">
								<img src="/Views/assets/images/offer/02.jpg" class="card-img rounded-0" alt="">
							</div>
	...
	<div class="container">
		<div class="row g-4 justify-content-between align-items-center">
			...
			<div class="col-lg-5 position-relative">
				...
				<!-- Image -->
				<img src="/Views/assets/images/about/01.jpg" class="rounded-3 position-relative" alt="">
				...
				<div class="position-absolute bottom-0 start-0 z-index-1 mb-4 ms-5">
					<div class="bg-body d-flex d-inline-block rounded-3 position-relative p-3">	
						...
						<!-- Element -->
						<img src="/Views/assets/images/element/01.svg" class="position-absolute top-0 start-0 translate-middle w-40px" alt="">
						...
						<div class="me-4">
							...
							<ul class="avatar-group mb-0">
								<li class="avatar avatar-sm">
									<img class="avatar-img rounded-circle" src="/Views/assets/images/avatar/01.jpg" alt="avatar">
								</li>
								<li class="avatar avatar-sm">
									<img class="avatar-img rounded-circle" src="/Views/assets/images/avatar/02.jpg" alt="avatar">
								</li>
								<li class="avatar avatar-sm">
									<img class="avatar-img rounded-circle" src="/Views/assets/images/avatar/03.jpg" alt="avatar">
								</li>
								<li class="avatar avatar-sm">
									<img class="avatar-img rounded-circle" src="/Views/assets/images/avatar/04.jpg" alt="avatar">
								</li>
								<li class="avatar avatar-sm">
		...
		<div class="row g-4">
			...
			<div class="col-sm-6 col-xl-3">
				...
				<div class="card card-img-scale overflow-hidden bg-transparent">
					...
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Image -->
						<img src="/Views/assets/images/category/hotel/01.jpg" class="card-img" alt="hotel image">
						<!-- Badge -->
			...
			<div class="col-sm-6 col-xl-3">
				...
				<div class="card card-img-scale overflow-hidden bg-transparent">
					...
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Image -->
						<img src="/Views/assets/images/category/hotel/02.jpg" class="card-img" alt="hotel image">
						<!-- Badge -->
						<div class="position-absolute bottom-0 start-0 p-3">
			...
			<div class="col-sm-6 col-xl-3">
				...
				<div class="card card-img-scale overflow-hidden bg-transparent">
					...
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Image -->
						<img src="/Views/assets/images/category/hotel/03.jpg" class="card-img" alt="hotel image">
						<!-- Badge -->
						<div class="position-absolute bottom-0 start-0 p-3">
			...
			<div class="col-sm-6 col-xl-3">
				...
				<div class="card card-img-scale overflow-hidden bg-transparent">
					...
					<div class="card-img-scale-wrapper rounded-3">
						<!-- Image -->
						<img src="/Views/assets/images/category/hotel/04.jpg" class="card-img" alt="hotel image">
						<!-- Badge -->
						<div class="position-absolute bottom-0 start-0 p-3">
	...
	<div class="container">
		<div class="row g-4 g-lg-7 justify-content-center align-items-center">
			...
			<div class="col-5 col-sm-3 col-xl-2">
				<img src="/Views/assets/images/client/01.svg" class="grayscale" alt="">
			</div>
			<!-- Image -->
			<div class="col-5 col-sm-3 col-xl-2">
				<img src="/Views/assets/images/client/02.svg" class="grayscale" alt="">
			</div>
			<!-- Image -->
			<div class="col-5 col-sm-3 col-xl-2">
				<img src="/Views/assets/images/client/03.svg" class="grayscale" alt="">
			</div>
			<!-- Image -->
			<div class="col-5 col-sm-3 col-xl-2">
				<img src="/Views/assets/images/client/04.svg" class="grayscale" alt="">
			</div>
			<!-- Image -->
			<div class="col-5 col-sm-3 col-xl-2">
				<img src="/Views/assets/images/client/05.svg" class="grayscale" alt="">
			</div>
			<!-- Image -->
			<div class="col-5 col-sm-3 col-xl-2">
				<img src="/Views/assets/images/client/06.svg" class="grayscale" alt="">
			</div>
		</div>
	</div>
</section>
							...
							<div class="row justify-content-between align-items-center">
								...
								<div class="col-md-6 col-lg-5 position-relative">
									...
									<div class="position-absolute top-0 start-0 translate-middle z-index-9 mt-7 ms-4">
										<img src="/Views/assets/images/element/02.svg" class="h-60px bg-orange rounded p-2" alt="">
									</div>
									...
									<!-- Image -->
									<img src="/Views/assets/images/team/01.jpg" class="rounded-3 position-relative" alt="">
								</div>
							...
							<div class="row justify-content-between align-items-center">
								...
								<div class="col-md-6 col-lg-5 position-relative">
									...
									<div class="position-absolute top-0 start-0 translate-middle mt-7 ms-4 z-index-9">
										<img src="/Views/assets/images/element/03.svg" class="h-60px bg-orange p-2 rounded" alt="">
									</div>
									...
									<!-- Image -->
									<img src="/Views/assets/images/team/02.jpg" class="rounded-3 position-relative" alt="">
								</div>
		...
		<div class="row g-4 g-md-5">
			...
			<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
				<div class="card bg-transparent text-center p-1 h-100">
					<!-- Image -->
					<img src="/Views/assets/images/category/hotel/nearby/01.jpg" class="rounded-circle" alt="">
			...
			<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
				<div class="card bg-transparent text-center p-1 h-100">
					<!-- Image -->
					<img src="/Views/assets/images/category/hotel/nearby/02.jpg" class="rounded-circle" alt="">
			...
			<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
				<div class="card bg-transparent text-center p-1 h-100">
					<!-- Image -->
					<img src="/Views/assets/images/category/hotel/nearby/03.jpg" class="rounded-circle" alt="">
			...
			<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
				<div class="card bg-transparent text-center p-1 h-100">
					<!-- Image -->
					<img src="/Views/assets/images/category/hotel/nearby/04.jpg" class="rounded-circle" alt="">
			...
			<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
				<div class="card bg-transparent text-center p-1 h-100">
					<!-- Image -->
					<img src="/Views/assets/images/category/hotel/nearby/05.jpg" class="rounded-circle" alt="">
			...
			<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
				<div class="card bg-transparent text-center p-1 h-100">
					<!-- Image -->
					<img src="/Views/assets/images/category/hotel/nearby/06.jpg" class="rounded-circle" alt="">
			...
			<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
				<div class="card bg-transparent text-center p-1 h-100">
					<!-- Image -->
					<img src="/Views/assets/images/category/hotel/nearby/07.jpg" class="rounded-circle" alt="">
			...
			<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
				<div class="card bg-transparent text-center p-1 h-100">
					<!-- Image -->
					<img src="/Views/assets/images/category/hotel/nearby/08.jpg" class="rounded-circle" alt="">
			...
			<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
				<div class="card bg-transparent text-center p-1 h-100">
					<!-- Image -->
					<img src="/Views/assets/images/category/hotel/nearby/09.jpg" class="rounded-circle" alt="">
			...
			<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
				<div class="card bg-transparent text-center p-1 h-100">
					<!-- Image -->
					<img src="/Views/assets/images/category/hotel/nearby/10.jpg" class="rounded-circle" alt="">
			...
			<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
				<div class="card bg-transparent text-center p-1 h-100">
					<!-- Image -->
					<img src="/Views/assets/images/category/hotel/nearby/11.jpg" class="rounded-circle" alt="">
			...
			<div class="col-lg-6 col-xl-5 col-xxl-3 ms-xxl-auto">
				...
				<div class="row g-3">
					...
					<div class="col-6 col-sm-4 col-md-3 col-lg-6">
						<a href="#"> <img src="/Views/assets/images/element/google-play.svg" alt=""> </a>
					</div>
					<!-- App store button -->
					<div class="col-6 col-sm-4 col-md-3 col-lg-6">
						<a href="#"> <img src="/Views/assets/images/element/app-store.svg" alt=""> </a>
					</div>
				</div>
			</div>
	...
	<div class="container">
		...
		<div class="row g-4">
			...
			<div class="col-lg-3">
				<!-- logo -->
				<a href="index.html">
					<img class="h-40px" src="/Views/assets/images/logo-light.svg" alt="logo">
				</a>
		...
		<div class="row g-4 justify-content-between mt-0 mt-md-2">
			...
			<div class="col-sm-7 col-md-6 col-lg-4">
				...
				<ul class="list-inline mb-0 mt-3">
					<li class="list-inline-item"> <a href="#"><img src="/Views/assets/images/element/paypal.svg" class="h-30px" alt=""></a></li>
					<li class="list-inline-item"> <a href="#"><img src="/Views/assets/images/element/visa.svg" class="h-30px" alt=""></a></li>
					<li class="list-inline-item"> <a href="#"><img src="/Views/assets/images/element/mastercard.svg" class="h-30px" alt=""></a></li>
					<li class="list-inline-item"> <a href="#"><img src="/Views/assets/images/element/expresscard.svg" class="h-30px" alt=""></a></li>
				</ul>
			</div>
...
<!-- Vendors -->
<script src="/Views/assets/vendor/tiny-slider/tiny-slider.js"></script>
<script src="/Views/assets/vendor/glightbox/js/glightbox.js"></script>
<script src="/Views/assets/vendor/flatpickr/js/flatpickr.min.js"></script>
