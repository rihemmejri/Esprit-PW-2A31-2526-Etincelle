...
if (isset($_GET['ajax']) && $_GET['ajax'] == 'details') {
    ...
    if ($id) {
        ...
        if ($recette) {
            // Générer l'URL de l'image en fonction du nom
...
function getImageUrl($nom) {
    if (strpos($nom, 'pizza') !== false) {
        return 'https://images.unsplash.com/photo-1513104890138-7c749659a591?w=400&h=250&fit=crop';
    } elseif (strpos($nom, 'tajine') !== false) {
        return 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400&h=250&fit=crop';
        ...
        return 'https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=400&h=250&fit=crop';
    } elseif (strpos($nom, 'pasta') !== false || strpos($nom, 'spaghetti') !== false) {
        return 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?w=400&h=250&fit=crop';
    } elseif (strpos($nom, 'riz') !== false) {
        return 'https://images.unsplash.com/photo-1536304993881-ff6e9eefa2a6?w=400&h=250&fit=crop';
    } elseif (strpos($nom, 'poulet') !== false) {
        return 'https://images.unsplash.com/photo-1598515214211-89d3c73ae83b?w=400&h=250&fit=crop';
    } elseif (strpos($nom, 'poisson') !== false) {
        return 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=400&h=250&fit=crop';
    } elseif (strpos($nom, 'glace') !== false || strpos($nom, 'ice cream') !== false) {
        return 'https://images.unsplash.com/photo-1576506295286-5cda18df43e7?w=400&h=250&fit=crop';
    } elseif (strpos($nom, 'soupe') !== false) {
        return 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400&h=250&fit=crop';
    } elseif (strpos($nom, 'burger') !== false) {
        return 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&h=250&fit=crop';
    } elseif (strpos($nom, 'crepe') !== false || strpos($nom, 'crêpe') !== false) {
        return 'https://images.unsplash.com/photo-1519676867248-6e4f6f4f0a1c?w=400&h=250&fit=crop';
    } elseif (strpos($nom, 'couscous') !== false) {
        return 'https://images.unsplash.com/photo-1617098900591-3f4c9b9f5a1a?w=400&h=250&fit=crop';
    } else {
...
<body>
        ...
        <?php if (count($recettes) > 0): ?>
            ...
            ?>
                <div class="recipe-card" 
                     ...
                     data-difficulte-texte="<?= $recette->getDifficulte() ?>"
                     data-type-texte="<?= $recette->getTypeRepas() ?>"
    ...
    <script>
        ...
        function showDetails(button) {
            ...
            const difficulte = card.getAttribute('data-difficulte-texte');
            const typeRepas = card.getAttribute('data-type-texte');
            ...
            modalBody.innerHTML = `
                ...
                ${origine && origine !== 'null' ? `<div class="modal-detail"><strong><i class="fas fa-globe"></i> Origine :</strong> <span>${origine}</span></div>` : ''}
